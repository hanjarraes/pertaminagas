      ...
      <div className='footer-content'>
          ...
          <div className="container mb-5">
            <div className='row mx-0 mx-md-2 text-left'>
              ...
              <div className='col-12 col-md-4 mt-4 mt-md-0 d-flex flex-column'>
                ...
                <a type='link' href="mailto:pcc135@pertamina.com" className='content-footer'><Sms /> pcc135@pertamina.com</a>
              </div>
            </div>
          </div>
        ...
        <div className='footer-icon-item'>
          ...
          <div className='d-flex'>
            <Button type='link' href="https://www.instagram.com/gas_negara/?hl=en" className='icon-social-footer mr-2'><Instagram /></Button>
            <Button type='link' href="https://twitter.com/gas_negara?lang=en" className='icon-social-footer mx-2'>
            ...
            <Button type='link' href="https://www.youtube.com/channel/UC9KAsjWek27hCNttej5KWMw" className='icon-social-footer mx-2'><Youtube variant="Bold" /></Button>
            <Button type='link' href="https://id-id.facebook.com/pgn.co.id/" className='icon-social-footer ml-2'><Facebook variant="Bold" /></Button>
          </div>
        </div>
      </div>
    </footer>
