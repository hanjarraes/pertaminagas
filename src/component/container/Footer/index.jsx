    ...
    <footer>
      <div className='footer-content'>
        ...
        <div className='d-flex align-items-start mt-4 mt-md-0'>
          <img src={LogoPertamina} alt="LogoPertamina" className='d-none d-md-block img-widht' />
        ...
        <div className='footer-icon-item'>
          ...
          <div className='d-flex'>
            <a href="https://www.instagram.com/gas_negara/?hl=en" target="_blank" className='icon-social-footer mr-2' rel="noreferrer">
