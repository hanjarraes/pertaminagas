  ...
  return (
    <div className="proses gradient-bg-to ">
      ...
      <div className="desc-proses" data-aos="fade-up">
        Kami selalu mengutamakan keamanan dan hasil yang terbaik bagi Anda.
        Sehingga, proses pengaliran gas ke rumah Anda akan memerlukan waktu yang
        tidak sebentar
      </div>
                    ...
                    (
                      <>
                        ...
                        <a href={data.ctaLink} target="_blank" rel="noreferrer">
                          <div className="title">{data.ctaText}</div>
                        </a>
                      </>
                    )}
                </div>
